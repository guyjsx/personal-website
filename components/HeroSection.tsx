...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    const isSmall = window.innerWidth < 640; // match hidden sm:block
    if (isSmall) return;
    ...
    const start = () => setVideoSrc(videoUrl);
    ...
    >
      ...
      {enableVideo && videoSrc && (
        <div className="absolute inset-0 -z-10 hidden sm:block">
          <video
            className="absolute inset-0 h-full w-full object-cover opacity-80 hero-video"
            src={videoSrc}
      ...
      <div className="content-width">
        ...
        <div className="text-center mb-16">
          <div className="opacity-0 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-[1.05] tracking-tight text-balance">
          ...
          <div className="opacity-0 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <p className="text-lg md:text-xl text-white/80 mb-12 max-w-3xl mx-auto leading-snug">
          ...
          <div className="opacity-0 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="px-8 py-4 bg-white text-gray-900 font-medium rounded-full hover:bg-gray-100 transition-colors duration-200 shadow-sm"
              >
                Explore My Work
              </button>
              ...
              <button
                ...
                className="px-8 py-4 border border-white/30 text-white font-medium rounded-full hover:border-white/50 hover:bg-white/10 transition-colors duration-200"
              >
                Let&apos;s Connect
              </button>
              <a
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 opacity-0 animate-fade-in-up" style={{ animationDelay: '1.0s' }}>
            ...
            <div className="grid grid-cols-3 gap-6 text-center">
              <div className="clean-card p-4" style={{ background: 'rgba(255,255,255,0.9)' }}>
